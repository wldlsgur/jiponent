 ...
 *
 * ### 속성(Props)
 * - **children:** 이 컴포넌트는 자식 컴포넌트로 `ImageSelect.Label`, `ImageSelect.View`, `ImageSelect.ListView`를 받습니다. 이를 통해 사용자는 이미지 업로드 입력창, 업로드된 이미지 보기, 업로드된 이미지 리스트 보기 등의 기능을 사용할 수 있습니다.
